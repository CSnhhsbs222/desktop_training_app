window.HUB_DATA = {
  ...
  trainings: [
    ...
    { id: 'groups', title: 'Starting School-Based Group Therapy', trainer: 'Topher Fuqua, LMFT', purpose: 'Moving from group idea to school-based implementation with clear structure, consent, care planning, Avatar expectations, facilitation rhythm, and a realistic launch plan.', objectives: ['Explain why group therapy can be clinically effective in a school-based setting', 'Choose a group focus that fits student needs, school culture, and therapist capacity', 'Design a simple group structure with purpose, target participants, session flow, and referral criteria', 'Complete consent, care plan, documentation, and Avatar workflow expectations before launch', 'Create a month-one implementation plan that supports confident, sustainable group facilitation'], resources: ['Starting School-Based Group Therapy'] },
    { id: 'cohort', title: 'New Hire Group', trainer: 'Tiffany Lester, LCSW', purpose: 'Eight-week cohort support that helps new school-based therapists build confidence, autonomy, reflection, peer connection, and sustainable problem-solving habits during ramp-up.', objectives: ['Connect with cohort peers and normalize the early learning curve of school-based work', 'Use weekly reflection to identify strengths, growth areas, and support needs', 'Strengthen sustainable workflow habits for scheduling, documentation, caregiver engagement, and school collaboration', 'Practice reasoning through real school-based scenarios, including crisis response, boundaries, and protocol questions', 'Exchange interventions, resources, and practical strategies that increase confidence and independence'], resources: ['New Hire Cohort Workbook', 'New Hire Group Weekly Rotatable Deck'] }
  ],
  sessionTypes: [
